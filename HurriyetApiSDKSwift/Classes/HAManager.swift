...
class HAManager: NSObject {
    
    
    private var apiKey:String?
    private let baseUrl:String = "https://api.hurriyet.com.tr/v1"
    static let sharedInstance = HAManager()
    private override init() {}

    func initWith(ApiKey apiKey:String!){
        HAManager.sharedInstance.apiKey = apiKey;
    }
    
    func makeRequest(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, Path path:String, complationHandler: @escaping (DataResponse<Any>) -> Void)
    {
    ...
    func getArticles(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler:@escaping (_ result:Array<HAArticle>) -> Void)
    {
    ...
    func getArticleDetail(ArticleId articleId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAArticle?) -> Void)
    {
    ...
    func getColumns(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler: @escaping (_ result:Array<HAColumn>) -> Void)
    {
    ...
    func getColumnDetail(ColumnId columnId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAColumn?) -> Void)
    {
    ...
    func getDate(complationHandler:@escaping (_ result:HADate?) -> Void)
    {
    ...
    func getPhotoGalleries(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler: @escaping (_ result:Array<HAPhotoGallery>) -> Void)
    {
    ...
    func getPhotoGalleryDetail(PhotoGalleryId photoGalleryId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAPhotoGallery?) -> Void)
    {
    ...
    func getPages(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler:@escaping (_ result:Array<HAPage>) -> Void)
    {
    ...
    func getPageDetail(PageId pageId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAPage?) -> Void)
    {
    ...
    func getPaths(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler:@escaping (_ result:Array<HAPath>) -> Void)
    {
    ...
    func getPathDetail(PathId pathId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAPath?) -> Void)
    {
    ...
    func getWriters(Filter filter:HAFilter?, SelectableList selectableList:Array<HASelectable>?, ResultCount resultCount:Int?, complationHandler:@escaping (_ result:Array<HAWriter>) -> Void)
    {
    ...
    func getWriterDetail(WriterId writerId:String, SelectableList selectableList:Array<HASelectable>?, complationHandler:@escaping (_ result:HAWriter?) -> Void)
    {
